...
let static =
  exce(`select Count(*) as count from visits_tests where YEAR(insert_record_date) = YEAR(CURRENT_DATE()) and is_done=0;
select Count(*) as count from visits_tests where YEAR(insert_record_date) = YEAR(CURRENT_DATE()) and is_done=1;
select Count(*) as count from visits_tests where MONTH(insert_record_date)= MONTH(date('now')) AND YEAR(insert_record_date) = YEAR(CURRENT_DATE()) and is_done=0;
select Count(*) as count from visits_tests where MONTH(insert_record_date)= MONTH(date('now')) AND YEAR(insert_record_date) = YEAR(CURRENT_DATE()) and is_done=1;
